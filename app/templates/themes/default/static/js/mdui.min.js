...
!function(t, e) {
    ...
    var e = function(t, e, n) {
        ...
        x.fn.extend({
            ...
            position: function() {
                ...
                return "fixed" === this.css("position") ? e = this[0].getBoundingClientRect() : (t = this.offsetParent(),
                e = this.offset(),
                function(t, e) {
            ...
            show: function() {
                return this.each(function() {
                    ...
                    "none" === t.getComputedStyle(this, "").getPropertyValue("display") && (this.style.display = function(t) {
                        var n, i;
                        return g[t] || (n = e.createElement(t),
                            ...
                            e.split(" ").forEach(function(e) {
                                var a = {
                                  ...
                                  , l = a.proxy = function(e) {
                                    e._data = o,
                                    r ? x(t).find(r).get().reverse().forEach(function(t) {
        ...
        function() {
            ...
            x.extend({
                ...
                ajax: function(l) {
                    ...
                    var y = (l = x.extend({}, p, l)).method = l.method.toUpperCase();
                    l.url || (l.url = t.location.toString());
                    var $;
                    if ($ = (r(y) || l.processData) && l.data && [ArrayBuffer, Blob, Document, FormData].indexOf(l.data.constructor) < 0 ? u(l.data) ? l.data : x.param(l.data) : l.data,
                    r(y) && $ && (l.url = c(l.url, $),
                    $ = null),
                    "jsonp" === l.dataType) {
                    ...
                    l.headers && o(l.headers, function(t, e) {
                    ...
                    l.xhrFields && o(l.xhrFields, function(t, e) {
                        T[t] = e
                    }),
                    b.xhr = T,
                    b.options = l;
                    ...
                    return T.onload = function() {
                        ...
                        if (e) {
                            ...
                            f(s.ajaxError, b),
                            h("error", T, t);
                        o([g.statusCode, l.statusCode], function(i, o) {
    ...
    t.Headroom = function() {
        function t(t, i) {
            if (this.$headroom = e(t).eq(0),
            this.$headroom.length) {
    ...
    function() {
        var t = {
            ...
            show: function(t, n) {
                if (2 !== t.button) {
                    var i, o = (i = "touches"in t && t.touches.length ? t.touches[0] : t).pageX, a = i.pageY, s = n.offset(), r = o - s.left, c = a - s.top, d = n.innerHeight(), u = n.innerWidth(), l = Math.max(Math.pow(Math.pow(d, 2) + Math.pow(u, 2), .5), 48), f = "translate3d(" + (u / 2 - r) + "px, " + (d / 2 - c) + "px, 0) scale(1)";
        ...
        n.on(a.start, function(n) {
            if (a.isAllow(n) && (a.register(n),
            n.target !== document)) {
                var i, o = e(n.target);
                if ((i = o.hasClass("mdui-ripple") ? o : o.parents(".mdui-ripple").eq(0)).length) {
                    if (i[0].disabled || null !== i.attr("disabled"))
                        return;
    ...
    t.Select = function() {
        ...
        return t.prototype.open = function() {
            ...
            function(t) {
                var e, n, o = i.height(), a = t.options.gutter, s = t.options.position, r = parseInt(t.$select.height()), c = t.$items.eq(0), d = parseInt(c.height()), u = parseInt(c.css("margin-top")), l = parseFloat(t.$select.width() + .01), f = d * t.size + 2 * u, h = t.$select[0].getBoundingClientRect().top;
                if ("auto" === s) {
                    var p = o - 2 * a;
                    f > p && (f = p),
    ...
    t.Tab = function() {
        ...
        t.prototype._setIndicatorPosition = function() {
            var t, e;
            !1 !== this.activeIndex ? (t = this.$tabs.eq(this.activeIndex),
            o(t) || (e = t.offset(),
            this.$indicator.css({
        ...
        t.prototype.prev = function() {
            !1 !== this.activeIndex && (this.activeIndex > 0 ? this.activeIndex-- : this.options.loop && (this.activeIndex = this.$tabs.length - 1),
            this._setActive())
        }
        ,
    ...
    t.Drawer = function() {
        ...
        var n = {
          ...
          , a = function(t) {
            ...
            function r(i) {
                ...
                if (h)
                    ...
                    var r = Math.abs(o - u)
                      , d = Math.abs(s - l);
                    r > 8 && d <= 8 ? (f = o,
                    h = "opened" === t.state ? "closing" : "opening",
                    e.lockScreen(),
                    n(a(o), !0)) : r <= 8 && d > 8 && c()
                }
            }
            ...
            var d, u, l, f, h = !1, p = !1, m = e("body"), v = 24;
    ...
    t.Dialog = function() {
        ...
        return t.prototype._doOpen = function() {
            ...
            a[t.options.modal ? "off" : "on"]("click", h).css("opacity", t.options.overlay ? "" : 0),
            t.options.history) {
    ...
    t.dialog = function(n) {
        ...
        e.each(n.buttons, function(t, o) {
            n.buttons[t] = e.extend({}, i, o)
        });
        var o = "";
        n.buttons.length && (o = '<div class="mdui-dialog-actions ' + (n.stackedButtons ? "mdui-dialog-actions-stacked" : "") + '">',
    ...
    t.Tooltip = function() {
        function t(t, i) {
            ...
            o.$target.length) {
                ...
                o.$target.on("touchstart mouseenter", function(t) {
        ...
        t.prototype.open = function(t) {
            ...
            if ("opening" !== n.state && "opened" !== n.state) {
                ...
                function(t) {
                    var e, n, a, s = t.$target[0].getBoundingClientRect(), r = o() ? 14 : 24, c = t.$tooltip[0].offsetWidth, d = t.$tooltip[0].offsetHeight;
                    switch (a = t.options.position,
                    -1 === ["bottom", "top", "left", "right"].indexOf(a) && (a = s.top + s.height + r + d + 2 < i.height() ? "bottom" : r + d + 2 < s.top ? "top" : r + c + 2 < s.left ? "left" : s.width + r + c + 2 < i.width() - s.left ? "right" : "bottom"),
                    a) {
                    case "bottom":
                        e = c / 2 * -1,
                        n = s.height / 2 + r,
    ...
    t.Menu = function() {
        ...
        var o = {
          ...
          , a = function(t) {
            var e, n, o, a, s, r, c = i.height(), d = i.width(), u = t.options.gutter, l = t.isCovered, f = t.options.fixed, h = t.$menu.width(), p = t.$menu.height(), m = t.$anchor, v = m[0].getBoundingClientRect(), g = v.top, b = v.left, x = v.height, y = v.width, $ = c - g - x, w = d - b - y, C = m[0].offsetTop, k = m[0].offsetLeft;
            if (o = "auto" === t.options.position ? $ + (l ? x : 0) > p + u ? "bottom" : g + (l ? x : 0) > p + u ? "top" : "center" : t.options.position,
            a = "auto" === t.options.align ? w + y > h + u ? "left" : b + y > h + u ? "right" : "center" : t.options.align,
            "bottom" === o)
                r = "0",
                n = (l ? 0 : x) + (f ? g : C);
            else if ("top" === o)
          ...
          , s = function(t) {
            !function(t) {
                var e, n, o, a, s, r, c = t.parent(".mdui-menu-item"), d = i.height(), u = i.width(), l = t.width(), f = t.height(), h = c[0].getBoundingClientRect(), p = h.width, m = h.height, v = h.left, g = h.top;
            ...
            "hover" === t.options.subMenuTrigger) {
                ...
                t.$menu.on("mouseover mouseout", ".mdui-menu-item", function(a) {
                    ...
                    if (null === r.attr("disabled")) {
                        if ("mouseover" === d) {
                            if (!r.is(u) && e.contains(r[0], u[0]))
                                return
                        } else if ("mouseout" === d && (r.is(u) || e.contains(r[0], u[0])))
                            return;
